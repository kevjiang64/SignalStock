...
export const sendSignUpEmail = inngest.createFunction(
    ...
    async ({event, step}) => {
        ...
        await step.run("send-welcome-email", async () => {
            ...
            const introText = (part && 'text' in part ? part.text: null) || "Thanks for joining SignalStocks! You now have the tools to track the market."
...
//Send news every day at 12 pm utc ==> because of cron job
export const sendDailyNewsSummary = inngest.createFunction(
    ...
    async ({ step }) => {
        ...
        //2. Personalize news for each user
